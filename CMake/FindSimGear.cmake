...
# 20140918: Modified by Geoff R. McLane for cf-log projects.
...
if (NOT SIMGEAR_INCLUDE_DIR)
    message(STATUS "*** Cannot find SimGear includes! "
            "When using non-standard locations, use ENV 'SIMGEAR_DIR' "
            "or use -DCMAKE_PREFIX_PATH= to set the SimGear location.")
else ()
...
if((NOT SIMGEAR_CORE_LIBRARIES) OR (NOT SIMGEAR_LIBRARIES))
    message(FATAL_ERROR "*** Cannot find SimGear includes! "
            "When using non-standard locations, use ENV 'SIMGEAR_DIR' "
            "or use -DCMAKE_PREFIX_PATH= to set the SimGear location.")
else()
